...
class Dashboard extends CI_Controller {
	...
	public function index(){
		...
		if(isset($_POST['fecha1'])){
			...
			$data['cliente']=$this->Clientes_model->get_cliente($_POST['id_cliente'],$this->session->userdata('base'));
			$data['lecturas']=$this->Clientes_model->get_lecturas(
				$data['fecha1'],
				$data['fecha2'],
				$data['id_cliente'],
				$this->session->userdata('base')
			);
		}
